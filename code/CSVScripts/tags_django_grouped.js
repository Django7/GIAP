...
var sql =
    "SELECT iid, tag, COUNT (*) AS count\n" +
    "FROM image_tags\n" +
    "WHERE uid > 20 AND uid < 6410\n" +
    "GROUP BY iid, tag\n" +
...
function createTimingsCSV() {
    dbConnection.query(sql, [], function (err, results) {
        ...
        fs.unlink('CSVDjango/tags_grouped.csv', function(err) {
            fs.appendFile('CSVDjango/tags_grouped.csv', csvString, function(err) {
                if (err) throw err;

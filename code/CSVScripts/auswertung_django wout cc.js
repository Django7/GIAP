...
"\t(SELECT uid, json_answer\n" +
    "    FROM questionnaires_users\n" + //first 3 because they dont want to be included //5731 because of random gender // rest because do not think their data should be used //2931 because of technical problem //551 no tags //2251 nur wunderschön // danach wegen times analyse (431) //4051 wegen schimpwörtern, 2871,4211,5461 wegen qualitiy unter 1,5
    "    WHERE qid = 4 AND uid < 6400 AND NOT (uid = 531 OR uid = 3751 OR uid = 4251 OR uid = 5731 OR uid = 1671 OR uid = 1801 OR uid = 4561 OR uid = 5191 OR uid = 5891 OR uid = 6131 OR uid = 6141 OR uid = 6161 OR uid = 2931 OR uid = 551 OR uid = 2251 OR uid = 431 OR uid = 6271 OR uid = 6321 OR uid = 6391 OR uid = 4051 OR uid = 2871 OR uid = 4211 OR uid = 5461)) AS kim_enjoyment_choice1\n" + 
    "    \n" +
    "    LEFT JOIN\n" +
    "    \n" +
    "    (SELECT uid, json_answer\n" +
...
function createAuswertungCSV() {
    dbConnection.query(sql, [], function (err, results) {
        ...
        var IMIString = "KIM_enjoyment_1. Gesamtrating KIM enjoyment nach Tutorial_1; KIM_enjoyment_2. Gesamtrating KIM enjoyment nach Tutorial_2;IMI_interest_enjoyment. Gesamtrating KIM enjoyment nach Main Task;IMI_perceived_competence. Gesamtrating KIM competence nach Main Task ;IMI_perceived_choice. Gesamtrating KIM choice nach Main Task;IMI_pressure_tension. Gesamtrating KIM pressure nach Main Task;";
        ...
        results.forEach(function(row, idx) {
            ...
            if(!(final_control == null && final_abs == null && final_rel == null && final_C_abs == null && final_C_rel == null) && checkJSONValue(row.normTags) != null ){
...
switch(condition){
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi_control.imi_interest_enjoyment.tagging_entertaining_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi_control.imi_interest_enjoyment.tagging_success_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi_control.imi_interest_enjoyment.tagging_choice_generic_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi_control.imi_interest_enjoyment.tagging_concerns_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi.imi_interest_enjoyment.tagging_entertaining_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi.imi_interest_enjoyment.tagging_success_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi.imi_interest_enjoyment.tagging_choice_generic_imi))) + ";";
    ...
    csvString += (
        ...
        parseInt(checkJSONValue(imi.imi_interest_enjoyment.tagging_concerns_imi))) + ";";
    break;
    case(5): //relative
    csvString += (
        parseInt(checkJSONValue(imi.imi_interest_enjoyment.tagging_fun_imi)) +
...
csvString += "\n";
        ...
        fs.unlink('CSVDjango_finals/auswertung_django_wout_cc.csv', function(err) {
            fs.appendFile('CSVDjango_finals/auswertung_django_wout_cc.csv', csvString, function(err) {
                if (err) throw err;
...
function getWhereFrom(string) {
    ...
    if(string.toLowerCase().includes("familie")) return 5;
    return string;
}

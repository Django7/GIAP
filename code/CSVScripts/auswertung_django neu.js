...
function createAuswertungCSV() {
    dbConnection.query(sql, [], function (err, results) {
        ...
        results.forEach(function(row, idx) {
            ...
            if(final_C_abs == null) {final_C_abs ={}; }
            if(final_C_rel == null) {final_C_rel ={}; } 
            ...
            if(debrief_C_abs == null) {debrief_C_abs ={}; } else {condition=6;}
            if(debrief_C_rel == null) {debrief_C_rel ={}; } else {condition=7;}
...
/*            switch(condition){
            ...
            switch(condition){
                ...
                csvString += checkJSONValue(demographic_control.gender) + ";";
                csvString += getNationality(checkJSONValue(demographic_control.nationality)) + ";";
                csvString += checkJSONValue(demographic_control.nationality) + ";";
                ...
                csvString += checkJSONValue(demographic_gami.gender) + ";";
                csvString += getNationality(checkJSONValue(demographic_gami.nationality)) + ";";
                csvString += checkJSONValue(demographic_gami.nationality) + ";";
...
switch(condition){
    ...
    csvString += "" + ";";
    csvString += "" + ";";
    csvString += checkJSONValue(choice_control.choice_specific_2.choice_none_extra_elements) + ";";
    csvString += "" + ";";
    csvString += "" + ";";
    csvString += checkJSONValue(choice_control.choice_specific_5.choice_none_options) + ";";
    csvString += getLinksRechts(checkJSONValue(choice_control.choice_specific_5_1.choice_none_decide)) + ";";
    ...
    csvString += choice_C_abs.choice_specific_1_1 !== undefined ? checkJSONValue(choice_C_abs.choice_specific_1_1).replace(/\n/g, "").replace(/;/g, "") + ";" : "" + ";";
    csvString += "" + ";";
    //csvString += "" + ";";
    //csvString += "" + ";";
    csvString += "" + ";";
    ...
    csvString += choice_C_rel.choice_specific_1_1 !== undefined ? checkJSONValue(choice_C_rel.choice_specific_1_1).replace(/\n/g, "").replace(/;/g, "") + ";" : "" + ";";
    csvString += "" + ";";
    //csvString += "" + ";";
    //csvString += "" + ";";
    csvString += "" + ";";
...
switch(condition){
    case(1): //control
    csvString += checkJSONValue(basics_control.gaming_time) + ";";
    ...
    break;
    case(4): //absolute
    csvString += checkJSONValue(basics_gami.gaming_time) + ";";
    csvString += "" + ";";
...
switch(condition){
    ...
    break;
    case(7): //choice_relative
    csvString += getYesNo(checkJSONValue(debrief_C_rel.end_usable));
    break;
}

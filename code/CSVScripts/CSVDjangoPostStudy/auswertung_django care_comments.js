...
csvString += "\n";
        ...
        fs.unlink('CSVDjangoPostStudy/auswertung_django_care_comments.csv', function(err) {
            fs.appendFile('CSVDjangoPostStudy/auswertung_django_care_comments.csv', csvString, function(err) {
                if (err) throw err;

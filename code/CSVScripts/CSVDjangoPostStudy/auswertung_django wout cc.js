...
csvString += "\n";
        ...
        fs.unlink('CSVDjangoPostStudy/auswertung_django_wout_cc.csv', function(err) {
            fs.appendFile('CSVDjangoPostStudy/auswertung_django_wout_cc.csv', csvString, function(err) {
                if (err) throw err;
